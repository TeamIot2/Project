...
const DEVICE_CONFIGS: DeviceConfig[] = [
  { info: { device_id: "esp32-001", name: "Unicorn-ESP32", location: "Unicorn-ESP32", last_seen: NOW.toISOString(), status: "online" as DeviceStatus, firmware_version: "1.2.0", battery_v: 3.95 }, seed: 42, batteryStart: 4.2, tempOffset: 0.5, co2Scale: 1.0 },
  { info: { device_id: "esp32-002", name: "Gym (mock)", location: "Gym placeholder", last_seen: NOW.toISOString(), status: "online" as DeviceStatus, firmware_version: "1.2.0", battery_v: 4.02 }, seed: 137, batteryStart: 4.15, tempOffset: -0.3, co2Scale: 1.2 },
  { info: { device_id: "esp32-004", name: "Greenhouse (mock)", location: "Greenhouse placeholder", last_seen: NOW.toISOString(), status: "online" as DeviceStatus, firmware_version: "1.0.0", battery_v: 3.88 }, seed: 999, batteryStart: 4.05, tempOffset: 1.2, co2Scale: 0.9 },
  { info: { device_id: "esp32-005", name: "School (mock)", location: "School placeholder", last_seen: NOW.toISOString(), status: "online" as DeviceStatus, firmware_version: "1.2.1", battery_v: 4.01 }, seed: 512, batteryStart: 4.18, tempOffset: 0.1, co2Scale: 1.1 },
];
...
function generateReadings(config: DeviceConfig): EnvironmentalReading[] {
  ...
  for (let i = 0; i < TOTAL; i++) {
    ...
    readings.push({
      ...
      gateway_id: "demo-auto-seed",
      source: "demo-auto-seed",
    });
  }
  return readings;
}
