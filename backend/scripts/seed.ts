...
const DEVICE_CONFIGS: DeviceConfig[] = [
  {
    info: { device_id: "esp32-001", name: "Living Room", location: "Living Room", last_seen: NOW.toISOString(), status: "online" as DeviceStatus, firmware_version: "1.2.0", battery_v: 3.95 },
  ...
  {
    info: { device_id: "esp32-003", name: "Bedroom", location: "Bedroom", last_seen: TWO_HOURS_AGO.toISOString(), status: "offline" as DeviceStatus, firmware_version: "1.1.3", battery_v: 3.42 },
    seed: 256, batteryStart: 4.1, tempOffset: -0.8, co2Scale: 0.8,
  },
  {
    info: { device_id: "esp32-004", name: "Garage", location: "Garage", last_seen: TWO_HOURS_AGO.toISOString(), status: "error" as DeviceStatus, firmware_version: "1.0.0", battery_v: 0 },
    seed: 999, batteryStart: 0, tempOffset: 0, co2Scale: 1,
  },
];
