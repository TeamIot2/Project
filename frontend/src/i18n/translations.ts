...
const cs: Translations = {
  ...
  device_sim_gym: "Gym (mock)",
  device_sim_office: "Unicorn-ESP32",
  device_sim_bedroom: "Unicorn-ESP32",
  device_sim_greenhouse: "Greenhouse (mock)",
  device_sim_school: "School (mock)",
  ...
  data_refresh_desc: "Každých 5 sekund",
...
const en: Translations = {
  ...
  device_name_placeholder: "e.g. Unicorn sensor",
  ...
  data_refresh_desc: "Every 5 seconds",
